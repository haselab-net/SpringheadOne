...
void TGLView::OnDraw()
{
	...
	//おそらくここでMODELVIEWの設定を行っている。
	//afCamという行列を単位行列にかけさえすればよい
	//なお、Ball.hの中でAffine.hをインクルードしている
...
void TGLView::renderScene(void){
	...
	//冷静に気づいたが、このプログラムではy軸の上下が逆っぽいなり。
	//否！translateのｙ軸の値を増やす　=　視点のy軸の値を減fらす　事に一致しているので。
