...
int UTStreambufBase::overflow(int c)
	{
	sync();
	if (c!=EOF)
		{
...
UTStreambufBase::pos_type UTStreambufBase::seekoff(off_type off, ios_base::seekdir way,
