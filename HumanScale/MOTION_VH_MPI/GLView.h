...
//VM Load view point
	...
	bool LoadSettings();
/////////////////////////////////////	
	TGeoNodes allNodes[20];			//	すべてのノード
	Vec3f clearColor[20];			//	空の色
...
// Tshirts (ytakeyama)
   Vec3f A0[8], A1[8], A2[8], A3[9];//Tshirtsの頂点
   Vec3f AA0[8], AA1[8], AA2[8], AA3[9];//Tshirtsの頂点
   double YTX, YTY;
   int bSeeTest;
   
   void TshirtsVertexSolver(int cur_frame);//頂点位置計算
   void TshirtsVertexInit();//頂点位置初期化
   void Tshirts();
//shadow
/////////////////////////
