...
public:
	...
	//小川追加関数
	void LoadCgVertexPrograms(int i, char* FileName, char* FuncName);
	void LoadCgFragmentPrograms(int i, char* FileName,char* FuncName);
	void EnableCgProfile(void);
	void DisableCgProfile(void);
	void BindVertexProgram(int i);
	void BindFragmentProgram(int i);
