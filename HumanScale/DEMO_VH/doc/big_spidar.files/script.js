...
var ENDSHOW_MESG="スライド ショーの最後です。 クリックすると終了します。", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=4, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0005.htm",1,-1,1),new hrefList("slide0001.htm",1,-1,1),new hrefList("slide0002.htm",1,-1,1),new hrefList("slide0004.htm",1,-1,1));
