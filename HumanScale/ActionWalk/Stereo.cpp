...
Affinef StereoV::ShiftCamera(Affinef afC){
/*
	afC.PosY() = 17.0;
	//視線を1.70mに設定
*/
	afC.PosY() = afC.PosY() + 17.0; //視線を1.7mに上げる　この方法でないと高さが変えられない.ただし足が浮いている状態になる.
	vecParallax = Vec3f(parallax, 0.0, 0.0);
