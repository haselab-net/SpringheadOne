...
inline  MyVector CopyVector(MyVector src);
...
inline void MyVector::Reset(void)
{
	x = 0;
	y = 0;
	z = 0;
...
// shadow 
inline void CalcShadowMat(double mat[4][4], tQuaternion Gn, MyVector vL)
{
   double kk= Gn.n * vL.x + Gn.v.x*vL.y + Gn.v.y * vL.z;
