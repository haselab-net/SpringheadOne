// Tokin.cpp: Tokin ƒNƒ‰ƒX‚ÌƒCƒ“ƒvƒŠƒƒ“ƒe[ƒVƒ‡ƒ“
//
//////////////////////////////////////////////////////////////////////
#include "Tokin.h"
...
{
	cout << "Tokin sensor Initializing COM" << endl;
...
void Tokin::GetDeviceData()
{
	...
	angle[0] = Tk3dIState.Alfa;	 //‚yŽ²‚Ü‚í‚è‚Ì‰ñ“]Šp
	angle[1] = Tk3dIState.Beta;	 //YŽ²‚Ü‚í‚è‚Ì‰ñ“]Šp
	angle[2] = Tk3dIState.Gamma; //XŽ²‚Ü‚í‚è‚Ì‰ñ“]Šp
