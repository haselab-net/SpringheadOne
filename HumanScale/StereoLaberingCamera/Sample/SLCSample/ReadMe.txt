========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SLCSample
========================================================================


AppWizard が生成した SLCSample には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SLCSample を構成している各ファイルの概要説明が含まれています。
...
SLCSample.h
    ...
    みます） をインクルードし、また CSLCSampleApp アプリケーションクラスを宣
    言します。

SLCSample.cpp
    このファイルは CSLCSampleApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SLCSample.ico
    ...
    ルです。このアイコンはリソース ファイル SLCSample.rc によってインクルード
    されます。
...
SLCSampleDlg.h, SLCSampleDlg.cpp - ダイアログ
    これらのファイルは CSLCSampleDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な SLCSample.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SLCSample.pch 
