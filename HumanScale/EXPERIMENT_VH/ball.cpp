...
void CBall::Init(MyVector init_range, int grdHeight)
{

   init_pos.x= init_range.x; //-5
   init_pos.y= init_range.y; //nRange
   init_pos.z= init_range.z; //-115
...
MyVector CBall::Reflect(double dt, MyVector off_v)
{
	  ...
	  double ref_vel = 68; //init_vel.y;  45 10 60 20
