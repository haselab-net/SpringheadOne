...
//2004/04/13
//2004/10/20 other motion add if he is same model
struct Default_Motion
{
  int m_id[NUM_MOVEMENT];
  int cur_frm[NUM_MOVEMENT];
  int total_frm[NUM_MOVEMENT];
  MyVector standing_trans[NUM_MOVEMENT];
  Model_Hieracrchy d_motion[NUM_MOVEMENT];
...
//2004.4.13 updated jeong
	...
	Anim_info Anim;
	void Create_Body(int m_id, MyBone t_body);
