...
: DirectX8が無い場合，VC6についてくるVer.5を使うので構成が違う．
if not "%DXLIB%"=="" set LIBS=dxguid.lib ddraw.lib d3d8.lib d3drm.lib d3dx.lib dsound.lib winmm.lib ws2_32.lib strmiids.lib Quartz.lib
if "%DXLIB%"=="" set LIBS=dxguid.lib ddraw.lib d3drm.lib dsound.lib winmm.lib ws2_32.lib strmiids.lib Quartz.lib
