...
# PROP Scc_ProjName ""$/Project/LVRM/WinBasis", JVKAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD LIB32 /nologo /out:"Release\WinBasis.lib"
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I ".." /I "$(LVRM_ROOT)" /D "_LIB" /D "DEBUG" /D "WIN32" /D "_DEBUG" /D "_MBCS" /YX /FD /I /mssdk/include" /GZ " /c
