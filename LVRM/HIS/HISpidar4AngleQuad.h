...
class HISpidar4anglequad: public HDForceDevice3DPlus{
public:
...
/*	float x_data[10000];
	...
	float z_data[10000];
//データ取得用　姿勢
	float quatang_data[10000];
//データ取得用　回転軸
	float quatvecX_data[10000];
	float quatvecY_data[10000];
	float quatvecZ_data[10000];
//データ取得用　角度
	float a1_data[10000];
	float a2_data[10000];
	float a3_data[10000];
