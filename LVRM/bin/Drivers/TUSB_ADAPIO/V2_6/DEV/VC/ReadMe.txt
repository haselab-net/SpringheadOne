========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : vcsample
========================================================================


AppWizard が生成した vcsample には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには vcsample を構成している各ファイルの概要説明が含まれています。
...
vcsample.h
    ...
    みます） をインクルードし、また CVcsampleApp アプリケーションクラスを宣
    言します。

vcsample.cpp
    このファイルは CVcsampleApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\vcsample.ico
    ...
    ルです。このアイコンはリソース ファイル vcsample.rc によってインクルード
    されます。
...
vcsampleDlg.h, vcsampleDlg.cpp - ダイアログ
    これらのファイルは CVcsampleDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な vcsample.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) vcsample.pch 
