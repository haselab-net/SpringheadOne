#ifndef Spr_WXD3D_WXD3DPDev_H
#define Spr_WXD3D_WXD3DPDev_H
#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000
#include "WXD3Dev.h"
...
//
///	WXD3D7用の光源
class SPR_DLL WXD3Light:public D3DLIGHT7{
public:
	WXD3Light();
};
...
class SPR_DLL WXD3Viewport:public D3DVIEWPORT7{
...
//
///	3D描画可能なサーフェイス
class SPR_DLL WXD3DPDevice:public WXDDFlipSurface{
protected:
	class SPR_DLL CZSurface:public WXDDSurface {
