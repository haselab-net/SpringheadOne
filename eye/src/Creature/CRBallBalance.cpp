// CRBallBalance.cpp: CRBallBalance クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
void CRBallBalance::Step(SGScene* scene,CRBallHuman* crHuman){

	Measure(scene,crHuman);
	ModifyBody(scene,crHuman);

}
void CRBallBalance::Measure(SGScene* scene,CRBallHuman* crHuman){
...
void CRBallBalance::ModifyBody(SGScene* scene,CRBallHuman* crHuman){
	ControlBody(crHuman);
}

void CRBallBalance::SetBalanceParameter(CRBallHuman* crHuman){
...
void CRBallBalance::Load(SGScene* scene,CRBallHuman* crHuman){
	if(crHuman->IsLoaded()){
		Init(scene,crHuman);
...
void CRBallBalance::Init(SGScene* scene,CRBallHuman* crHuman){
//	spring_no		= 0.0f;
	spring_noV		= Vec3f();
	dampa_no		= 0.0f;
	targetZmp		= Vec3f();
...
void CRBallBalance::OnKeyDown(UINT &nChar,CRBallHuman* crHuman){

}

void CRBallBalance::Draw(GRRender* render,CRSupportArea* supportArea){
	//目標ZMPの描画
	DrawZMP(render);
	//安定領域の描画
...
void CRBallBalance::DrawZMP(GRRender* render){
...
void CRBallBalance::ControlBody(CRBallHuman* crHuman){
...
void CRBallBalance::CalcTargetZMP(SGScene* scene,CRBallHuman* crHuman){
...
void CRBallBalance::CalcBalanceForce(SGScene* scene,CRBallHuman* crHuman){
...
void CRBallBalance::CalcBalanceTorque(SGScene* scene, CRBallHuman* crHuman){
...
bool CRBallBalance::ZmpIncludeCheck(CRSupportArea& supportArea){
...
bool CRBallBalance::PosIncludeTriangle(Vec3f t_a, Vec3f t_b, Vec3f t_c, Vec3f zmp){
