#include "Creature.h"
#pragma hdrstop
// CRBallBalanceQuadPR.cpp: CRBallBalanceQuadPR クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////

#include "CRBallBalanceQuadPR.h"
#include "CRBallHuman.h"
...
CRBallBalanceQuadPR::CRBallBalanceQuadPR()
{
...
bool CRBallBalanceQuadPR::CompNoJoint(int jointNum,CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::Init(SGScene* scene,CRBallHuman* crHuman){
	// 親クラスの初期化
	CRBallBalance::Init(scene,crHuman);
...
void CRBallBalanceQuadPR::SetBalanceParameter(CRBallHuman* crHuman){

	CRBallBalance::SetBalanceParameter(crHuman);
...
void CRBallBalanceQuadPR::ModifyBody(SGScene* scene,CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::SetTargetJointTorque(SGScene* scene,CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::CalcTransMatrix(SGScene* scene,CRBallHuman* crHuman){
	timer.Start();
...
Vec3d CRBallBalanceQuadPR::GetJointAccel(PHJoint1D* joint){
	// すべてWorld座標系
...
void CRBallBalanceQuadPR::MakeTorquePattern(CRBallHuman* crHuman, int t){
/////	関節のトルク、足首にかかる力すべて0	  //////
	if(t == 0){
		// 各関節トルクを0にする
		for(int i = 0; i < crHuman->joints.size(); i++){
...
void CRBallBalanceQuadPR::SetQuadPR(CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::QuadPRSolve(){
	timer.Start();
	// 二次計画法を解く
	count = quadPR.Solve();
...
void CRBallBalanceQuadPR::SetBalanceTorque(CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::AnkleBalance(CRBallHuman* crHuman){
...
Vec3d CRBallBalanceQuadPR::AdjustAnkleTorque(CRBallHuman* crHuman,Vec3d ankleForce,Vec3d ankleTorque,int ankle){
...
bool CRBallBalanceQuadPR::AnkleZmpCheck(Vec3f zmp,CRSupportArea* supportArea){
...
Vec3f CRBallBalanceQuadPR::CalcPoint(Vec3f p0, Vec3f p1,Vec3f zmp){
...
void CRBallBalanceQuadPR::RenewConstraint(CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::NewConstraint(CRBallHuman* crHuman,PHSolid* heel,Vec3f* maxRange,Vec3f* minRange,int ankleSide){
...
bool CRBallBalanceQuadPR::BalanceCheck(CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::OffSpring(){
...
void CRBallBalanceQuadPR::DataOut(CRBallHuman* crHuman){
...
void CRBallBalanceQuadPR::AnkleBalance2(CRBallHuman* crHuman){
...
Vec3d CRBallBalanceQuadPR::AdjustAnkleTorque2(CRBallHuman* crHuman,	Vec3d footForce,Vec3d footTorque,Vec3d zmp,int foot){
