...
/--------------------------------------------------------------------
|
|      $Id: plpngdec.h,v 1.4 2002/08/04 20:08:01 uzadow Exp $
|
...
private:
  ...
  static void __cdecl PLPNGDecoder::user_error_fn
    ( png_structp png_ptr,
      png_const_charp error_msg
    );

  static void __cdecl PLPNGDecoder::user_warning_fn
    ( png_structp png_ptr,
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpngdec.h $
 * 
