...
/--------------------------------------------------------------------
|
|      $Id: plfilterquantize.h,v 1.5 2004/06/15 10:26:13 uzadow Exp $
|
...
private:
  ...
  void genMedianPalette (PLBmpBase * pBmpSource, PLBmp * pBmpDest) const;
  void split (QUBOX * pBox0, QUBOX * pBox1, int ColComp) const;
  void squeeze(QUBOX * pBox) const;
  void genPopularityPalette (PLBmpBase * pBmpSource, PLBmp * pBmpDest) const;
  void genColorArray(PLBmpBase * pBmpSource) const;
  void genDefaultPalette (PLBmpBase * pBmpSource) const;
  ...
  void ditherDestBmp(PLBmpBase * pBmpSource, PLBmp * pBmpDest) const;
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/Filter/plfilterquantize.h $
 * 
