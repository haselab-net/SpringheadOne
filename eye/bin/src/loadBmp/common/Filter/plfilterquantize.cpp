...
/--------------------------------------------------------------------
|
|      $Id: plfilterquantize.cpp,v 1.10 2004/06/15 10:26:13 uzadow Exp $
|
...
void PLFilterQuantize::genColorArray (PLBmpBase * pBmpSource) const
{
  int x,y;
...
void PLFilterQuantize::genDefaultPalette (PLBmpBase * pBmpSource) const
{
  PLPixel32 * pPal = pBmpSource->GetPalette();
...
void PLFilterQuantize::ditherDestBmp(PLBmpBase * pBmpSource, PLBmp * pBmpDest) const
{
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/Filter/plfilterquantize.cpp $
 * 
 * 1     04/07/12 13:34 Hase
|      Revision 1.10  2004/06/15 10:26:13  uzadow
|      Initial nonfunctioning version of plbmpbase.
|
|      Revision 1.9  2003/11/05 15:17:26  artcom
