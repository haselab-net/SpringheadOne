...
/--------------------------------------------------------------------
|
|      $Id: plfilterresizegaussian.cpp,v 1.8 2004/06/15 10:26:13 uzadow Exp $
|
...
void PLFilterResizeGaussian::Apply(PLBmpBase * pBmpSource, PLBmp * pBmpDest) const
{
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/Filter/plfilterresizegaussian.cpp $
 * 
