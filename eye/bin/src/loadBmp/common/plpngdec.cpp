...
/--------------------------------------------------------------------
|
|      $Id: plpngdec.cpp,v 1.8 2002/08/04 20:08:01 uzadow Exp $
|      PNG Decoder Class
|
...
void __cdecl my_read_data(png_structp png_ptr, png_bytep data, png_size_t length)
{
...
void __cdecl PLPNGDecoder::user_error_fn
    ( png_structp png_ptr,
...
void __cdecl PLPNGDecoder::user_warning_fn
    ( png_structp png_ptr,
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpngdec.cpp $
 * 
