...
/--------------------------------------------------------------------
|
|      $Id: planybmp.h,v 1.8 2004/06/15 14:17:11 uzadow Exp $
|
...
//! Supported data formats are 1, 8, 24 and 32 bpp. The data is stored
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/planybmp.h $
 * 
