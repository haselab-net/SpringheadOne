...
/--------------------------------------------------------------------
|
|      $Id: plpixel16.h,v 1.3 2004/06/13 20:20:33 uzadow Exp $
|
...
{
  m_Data = PLWORD((((*(const PLLONG*)&Pix) & 0xF80000) >> 8) | 
                                 (((*(const PLLONG*)&Pix) & 0x00FC00) >> 5) | 
                                 (((*(const PLLONG*)&Pix) & 0x0000F8) >> 3));
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpixel16.h $
 * 
