...
/--------------------------------------------------------------------
|
|      $Id: plpictdec.cpp,v 1.10 2002/11/04 21:03:12 uzadow Exp $
...
void PLPictDecoder::GetImage (PLBmp & Bmp)
{
  switch (m_PictType)
  {
    case op9a:
    ...
    )
{
  ...
  SetBmpInfo (PLPoint (PixMap.Bounds.right - PixMap.Bounds.left,
              ...
              DestBPP, PLPoint (PixMap.hRes, PixMap.vRes), bAlpha, false);
}
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpictdec.cpp $
 * 
