...
/--------------------------------------------------------------------
|
|      $Id: plpngenc.cpp,v 1.8 2003/04/06 11:57:42 uzadow Exp $
|      PNG Encoder Class
|
...
void __cdecl raiseError (png_structp png_ptr, png_const_charp message)
{
...
void __cdecl raiseWarning (png_structp png_ptr, png_const_charp message)
{
}
...
void __cdecl EncodeData (png_structp png_ptr, png_bytep data, png_size_t length)
{
  PLPNGEncoder *pClass;
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpngenc.cpp $
 * 
