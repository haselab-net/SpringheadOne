...
/--------------------------------------------------------------------
|
|      $Id: plfilterfill.h,v 1.7 2004/06/06 12:56:38 uzadow Exp $
|
\--------------------------------------------------------------------
*/
...
//! 32 bpp 
template<class PixelC> class PLFilterFill : public PLFilter
{
public:
...
template<class PixelC>
void PLFilterFill<PixelC>::ApplyInPlace(PLBmp * pBmp) const
{
  pBmp->ApplyFilter (PLFilterFillRect<PixelC> (PLPoint(0,0),
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/Filter/plfilterfill.h $
 * 
