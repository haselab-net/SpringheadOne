...
/--------------------------------------------------------------------
|
|      $Id: plexcept.h,v 1.10 2004/06/06 12:56:38 uzadow Exp $
|
...
#define PL_ERRDFB            15            // Directfb operation failed.
...
public:
  ...
  //! PL_ERRDFB (15): Directfb operation failed.
  virtual int GetCode
    ()
    const;
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plexcept.h $
 * 
