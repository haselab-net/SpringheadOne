#ifndef Spr_WXD3D_WXD3Dev_H
#define Spr_WXD3D_WXD3Dev_H
#if _MSC_VER >= 1000
#pragma once
#endif // _MSC_VER >= 1000
...
///	3Dレンダリングドライバの配列
class SPR_DLL WXD3Drivers: public std::vector<WXD3Driver>{
protected:
	int cur;
...
//
///	3D描画可能なサーフェイス
class SPR_DLL WXD3Device:public WXDDFlipSurface{
public:
