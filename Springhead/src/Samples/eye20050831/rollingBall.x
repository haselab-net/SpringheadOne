...
Scene {
  ...
  ContactEngine{			# 衝突エンジン，SolidかFrameを並べる．
  ...
  Frame frTop{
		...
		Mesh { 
		 ...
		 MeshMaterialList {
		  ...
		  Material {                        ######### マテリアルを変更 ###########
			 ...
			 0.30;0.30;0.30;;
			 TextureFilename { "grass.jpg"; } # テクスチャを追加 ##
		  }                                 ######### ここまで ###################
		 }
		 MeshNormals {
		  6;
			...
			Mesh {
			 ...
			 MeshMaterialList {
			  ...
			  Material {                        ######### マテリアルを変更 #########
				 ...
				 0.000000;0.000000;0.000000;;
				 0.30;0.30;0.30;;
				 TextureFilename { "sand.jpg"; } # テクスチャを追加 #
			  }                                 ######### ここまで #################
			 }
			 MeshNormals {
			  5;
	...
	Frame Vessel{
		FrameTransformMatrix{
			...
			0.00,1.00,0.00,0.00,
			0.00,0.00,1.00,0.00,
			10.00,-1.00,0.00,1.00;;        
		}

		Material matVessel{	              #### 箱用のマテリアルを追加 #########
		 1.0; 1.0; 1.0; 1.0;;
		 5.000000;
		 0.000000;0.000000;0.000000;;
		 0.30;0.30;0.30;;
		 TextureFilename { "stone.jpg"; } # テクスチャを追加 #
		}                                 ######### ここまで #################
