 - テストアプリ(TestMain.bat)を使う準備 -

・環境変数のPathに以下のフォルダを指定する
  1. msdev.exeのあるフォルダ
     (例 - C:\Program Files\Microsoft Visual Studio\Common\MSDev98\Bin)
  2. ssexp.exeのあるフォルダ
     (例 - C:\Program Files\Microsoft Visual Studio\Common\VSS\win32\SSEXP.EXE)
...
1. "Springhead/srcフォルダ"以下のファイルをすべて消去する
 ...
 注意！！SVNの導入に伴ってこのフェーズはなくなりました
 ローカルのファイルを残したまま、アップデートします
