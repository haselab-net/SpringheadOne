// VirtualHumanView.h : CSampleProgramView クラスの宣言およびインターフェイスの定義をします。
//
/////////////////////////////////////////////////////////////////////////////
...
///	View
class CSampleProgramView : public CView
{
protected: // シリアライズ機能のみから作成します。
	CSampleProgramView();
	DECLARE_DYNCREATE(CSampleProgramView)
// アトリビュート
public:
	float dt;							///<	更新周期
	...
	CSampleProgramDoc* GetDocument();

	//テスト用
	CollisionArea collisionArea;					//　接触点の検出
	ControlObject contObj;							//　Ｘファイルのオブジェクトを操作
	Spr::PHHuman phHuman;
	std::vector<int> ii;
...
// オーバーライド
	...
	//{{AFX_VIRTUAL(CSampleProgramView)
	public:
...
inline CSampleProgramDoc* CSampleProgramView::GetDocument()
