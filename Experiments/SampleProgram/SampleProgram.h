// SampleProgram.h : SampleProgram アプリケーションのメイン ヘッダー ファイル
//

#if !defined(AFX_MFCD3DVIEWER_H__76565EAB_E58D_4F61_A6A0_E8BB59F3208B__INCLUDED_)
#define AFX_SampleProgram_H__76565EAB_E58D_4F61_A6A0_E8BB59F3208B__INCLUDED_
...
/** @page SampleProgram 物理シミュレータ(VisualC++ MFC SDI版)
	@section SampleProgramAbst 概要
	...
	@section SampleProgramHowToBuild ビルドの方法
	...
	- <A href=../../Samples/SampleProgram/SampleProgram.dsw>Samples/SampleProgram/SampleProgram.dsw</A>を
	  開いてビルドして実行してください．<br>
	...
	@section SampleProgramMouseHowToOperate 操作方法
	キーボード操作
	...
	@section SampleProgramPoint 見所
	- CSampleProgramViewクラス<br>
		メンバ変数に，render(レンダラ)，afBody*afHead(視点行列), 
		world(シーングラフのトップフレーム)を加えている．
	- CSampleProgramView::OnInitialUpdate()<br>
		初期化
	- CSampleProgramView::Load()<br>
		Xファイルのロード
	- CSampleProgramView::OnDraw()<br>
		レンダリング処理
	- CSampleProgramView::PreTranslateMessage()<br>
		マウスとキー入力処理．ここでキーとマウスのメッセージを見てしまっています．
	- CSampleProgramDoc::OnOpenDocument()<br>
...
/////////////////////////////////////////////////////////////////////////////
// CSampleProgramApp:
// このクラスの動作の定義に関しては SampleProgram.cpp ファイルを参照してください。
//
class CSampleProgramApp : public CWinApp
{
public:
	CSampleProgramApp();
...
// オーバーライド
	...
	//{{AFX_VIRTUAL(CSampleProgramApp)
	public:
	virtual BOOL InitInstance();
	//}}AFX_VIRTUAL

// インプリメンテーション
	//{{AFX_MSG(CSampleProgramApp)
...
#endif // !defined(AFX_SampleProgram_H__76565EAB_E58D_4F61_A6A0_E8BB59F3208B__INCLUDED_)
