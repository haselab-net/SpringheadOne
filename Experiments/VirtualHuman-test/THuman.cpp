...
void THuman::SaveTorque(float time, float dt){
		jojo[0].push_back(joRHip1->GetTorque());
		jojo[1].push_back(joRHip2->GetTorque());
		jojo[2].push_back(joRHip3->GetTorque());
		jojo[3].push_back(joRKnee1->GetTorque());
		jojo[4].push_back(joRAnkle1->GetTorque());
		jojo[5].push_back(joLHip1->GetTorque());
		jojo[6].push_back(joLHip2->GetTorque());
		jojo[7].push_back(joLHip3->GetTorque());
		jojo[8].push_back(joLKnee1->GetTorque());
		jojo[9].push_back(joLAnkle1->GetTorque());
		jojo[10].push_back(joLShin->GetTorque());
		jojo[11].push_back(joRShin->GetTorque());

		jojo[12].push_back(joWaist1->GetTorque());
		jojo[13].push_back(joWaist2->GetTorque());
		jojo[14].push_back(joWaist3->GetTorque());
		jojo[15].push_back(joNeck1->GetTorque());
		jojo[16].push_back(joNeck2->GetTorque());
		jojo[17].push_back(joNeck3->GetTorque());
		jojo[18].push_back(joRShoulder1->GetTorque());
		jojo[19].push_back(joRShoulder2->GetTorque());
		jojo[20].push_back(joRShoulder3->GetTorque());
		jojo[21].push_back(joRElbow1->GetTorque());
		jojo[22].push_back(joRWrist1->GetTorque());
		jojo[23].push_back(joRWrist2->GetTorque());
		jojo[24].push_back(joLShoulder1->GetTorque());
		jojo[25].push_back(joLShoulder2->GetTorque());
		jojo[26].push_back(joLShoulder3->GetTorque());
		jojo[27].push_back(joLElbow1->GetTorque());
		jojo[28].push_back(joLWrist1->GetTorque());
		jojo[29].push_back(joLWrist2->GetTorque());
