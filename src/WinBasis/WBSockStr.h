...
class SPR_DLL WBSockStreambuf:public UTStreambufBase{
	friend WBSockStream;
protected:
...
class SPR_DLL WBSockStream:public std::iostream{
protected:
