// CRBallPuppet.h: CRBallPuppet クラスのインターフェイス
//
//////////////////////////////////////////////////////////////////////
...
#if !defined(CRBALLPUPPET_H)
#define CRBALLPUPPET_H
...
class CRBallPuppet : public CRBallHuman{
public:
	SGOBJECTDEF(CRBallPuppet);
	//////////////////// PositionSpringクラス ////////////////////
	...
	public:
		...
		void SaveLog(CRBallPuppet* puppet);
		...
		void SetLocusCoefficient(CRBallPuppet* puppet, SGScene* scene);

		void PrintLocusCoefficient(CRBallPuppet* puppet);
		void PrintLogPos(CRBallPuppet* puppet);
	};
	//////////////////// HumanContactInfoクラス ////////////////////
	...
	virtual void CRBallPuppet::SetFixedPos();
	void SetExpectedPos(float dt);
	void SetSpringForce(float dt);

	void Step(SGScene* scene);

	void Attack(CRBallPuppet* puppet);
	void AttackTest(CRBallPuppet* puppet);
	bool IsAimed(CRBallPuppet* puppet, SGScene* scene);
	void GuardTest(CRBallPuppet* puppet, SGScene* scene);
	void ReachingMovemantsSafetyCheck(CRBallPuppet* puppet, SGScene* scene);
	void HittedCheck(CRBallPuppet* puppet, SGScene* scene);
