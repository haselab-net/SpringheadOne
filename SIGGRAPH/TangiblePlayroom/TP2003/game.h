...
public:
	...
	vector< UTRef<DispNode> > sprites;
	vector< UTRef<DispNode> > sprite2;
	vector< UTRef<DispNode> > sprite4;
	vector< UTRef<DispNode> > experiments; //AS 2003/07/10
	...
	void DrawSprite(int i,Vec3f pos);
	void DrawObject2d(int i, GLfloat x , GLfloat y , GLfloat z); //AS
	void Front();
	void AIEngine();
	void Judge();
