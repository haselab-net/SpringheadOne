...
//
//	ivolume		-- 設定したいボリューム0(DSBVOLUME_MAX)～-10000(DSBVOLUME_MIN)
//
...
//
///////////////////////////////////////////////////////////////////////////////
BOOL SndObjPlay(HSNDOBJ hSO, LONG ivolume, DWORD dwPlayFlags);
...
///////////////////////////////////////////////////////////////////////////////
//
// SndObjSetVolume SNDOBJのボリュームを変更する。
//
// Params:
//  hSO 	-- Handle to a SNDOBJ
//  vol		-- 設定したいボリューム0(DSBVOLUME_MAX)～-10000(DSBVOLUME_MIN)
//
// NOTES: ボリュームを変更する。バッファが複数個ある場合、すべて同じボリュームになる。
//
///////////////////////////////////////////////////////////////////////////////
BOOL	SndObjSetVolume(HSNDOBJ hS0, LONG vol);
*/
