...
public:
	...
	void Draw();
//	bool QhullSwitch(TPolytope* tope1, TPolytope* tope2);
	void Preprocessor(TPolytope* tope1, TPolytope* tope2);
	void CalcCommonArea();
	void CalcPenalty(TPolytope* tope1, TPolytope* tope2);
	void CalcTriPenalty(TFace* face);
	void CalcForceTorque(Vec3d& f, Vec3d& t, Vec3d* coord, double* depth);
	void OutputQhalf();
...
//	void Id2Coord(int dim, pointT* point, int id);
};
...
public:
	...
	void CalcForceTorque(Vec3d& f, Vec3d& t, double ra, double rb, Vec3d* coord, double* depth, const Vec3d& normal);
