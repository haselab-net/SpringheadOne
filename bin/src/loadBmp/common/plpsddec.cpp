...
/--------------------------------------------------------------------
|
|      $Id: plpsddec.cpp,v 1.6 2003/04/06 12:20:16 uzadow Exp $
|
    ...
    )
{
  ...
  return new PLBmpInfo (PLPoint (Width, Height), BPP, Resolution, bAlpha, bGreyscale);
...
/--------------------------------------------------------------------
|
|      $Log: /Project/Springhead/bin/src/loadBmp/common/plpsddec.cpp $
 * 
